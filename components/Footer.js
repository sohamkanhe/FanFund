...
const Footer = () => {
  ...
  return (
    <footer className='bg-black/30 backdrop-blur-sm text-white px-4 py-8 md:px-8 border-t border-white/10'>
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        
        {/* Left Section */}
        <div className='text-center md:text-left md:w-1/3'>
          <p className='font-bold text-lg'>FanFund</p>
          <p className='text-sm text-gray-400'>Copyright &copy; {currentYear} FanFund - All rights reserved!</p>
        </div>
        
        {/* Center Section */}
        <div className='flex-1 flex justify-center gap-6 text-sm text-gray-300'>
